...
Download the latest `.deb` or `.rpm` from the [releases page](https://github.com/lucky-verma/mwb-linux/releases).
```
...
2. Go to https://github.com/lucky-verma/mwb-linux/settings/secrets/actions
